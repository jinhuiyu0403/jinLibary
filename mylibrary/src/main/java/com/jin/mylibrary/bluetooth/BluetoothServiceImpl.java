...
import com.jin.mylibrary.bluetooth.connect.BleConnectManager;
...
import com.jin.mylibrary.bluetooth.search.BluetoothSearchManager;
 ...
 */
public class BluetoothServiceImpl implements Handler.Callback, IBluetoothService {
    ...
    @Override
    public void callBluetoothApi(int code, Bundle args, final IResponse response) {
